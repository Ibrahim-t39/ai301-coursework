...
I'm most comfortable in Python, particularly backend and data-adjacent
work (scripting, APIs, data processing). For this first issue I want to
branch out into something outside that comfort zone — a different
language or a part of a stack I haven't touched — rather than another
Python backend task. I'd like to avoid issues that need a lot of
domain-specific setup or hardware/environment I don't have access to;
prefer something I can get running locally without a long onboarding
process.
